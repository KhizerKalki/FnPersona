          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="grid gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Due on Jun 1</div>
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Due on Jun 15</div>
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Due on Jun 20</div>
                    </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Track your progress on financial goals</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-4">
                  <div>
                ...
                <div className="grid gap-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">You exceeded your monthly budget by $125.</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-muted">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Your checking account balance is below $500.</div>
                    </div>
                  </div>
                </div>
              </CardContent>
