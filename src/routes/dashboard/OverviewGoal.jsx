        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4'>
          <Card className='flex items-center'>
            <CardHeader className=''>
              <CardTitle className='text-lg ml-20'>Total Goals </CardTitle>
            </CardHeader>
          ...
          <Card className='flex items-center'>
            <CardHeader className=''>
              <CardTitle className='text-lg ml-20'> In Progress </CardTitle>
            </CardHeader>
            <CardContent className='gap-4 p-4 pt-2'>
              <div className='flex items-center gap-2 text-2xl font-bold tabular-nums leading-none'>
                {
          ...
          <Card className='flex items-center '>
            <CardHeader className=''>
              <CardTitle className='text-lg ml-20'> Completed </CardTitle>
            </CardHeader>
            <CardContent className='gap-4 p-4 pt-2'>
              <div className='flex items-center gap-2 text-2xl font-bold tabular-nums leading-none'>
                {
